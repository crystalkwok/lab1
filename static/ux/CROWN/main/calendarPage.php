...
<html>
	<head>
		...
		<link href="calendar/css/css.css" rel="stylesheet">
		<link href='http://fonts.googleapis.com/css?family=Lato:400,700' rel='stylesheet' type='text/css'>

            
		<!--more calendar css files-->
    	<link href='calendar/css/fullcalendar.css' rel='stylesheet' />
        <link href='calendar/css/fullcalendar.print.css' rel='stylesheet' media='print' />
        <!--calendar script links -->
        <script src='calendar/lib/events.js'></script>
        ...
        function viewChange(view) {
            ...
            var dayBorder = document.getElementById("dayPic");
            var weekBorder = document.getElementById("weekPic");
            var monthBorder = document.getElementById("monthPic");
    
            if (view == 'agendaDay')
            {
                $('.dailyview_calendar').addClass("active");
                $('.weeklyview_calendar').removeClass("active");
                $('.monthlyview_calendar').removeClass("active");
            }
            else if (view == 'agendaWeek')
            {
                $('.dailyview_calendar').removeClass("active");
                $('.weeklyview_calendar').addClass("active");
                $('.monthlyview_calendar').removeClass("active");
            }
            else if (view == 'month')
            {
                $('.dailyview_calendar').removeClass("active");
                $('.weeklyview_calendar').removeClass("active");
                $('.monthlyview_calendar').addClass("active");
            }
}
		...
		<div class="container_12">
			...
			<div class="top">
				...
				<div class="grid_3">
					...
					<!--Side Mini-Calendar-->
					<div class="calendar_button active">
						<img src="img/calendar button.jpg" height="40"/>
					</div>
					<!--End Side Mini-Calendar-->
				</div>
				<!--End Grid 3-->

				<!--Grid 2-->
				<div class="grid_2 timeline_button">
                    <a href="timelinePage.php"><img src="img/timeline button.jpg"></a>
				</div>
				<!--End Grid 2-->
						...
						<div class="dialog" style="display:none">
							<div class="title"> Add Event or Class</div>
						  	<form action="addevent.php" method="post">
							    ...
							    <br/>
							    <input name="start_dtm" type="text" class="eventstart_time" placeholder="Start Time (YYYY-MM-DD HH:MM)"/>
							    <br/>
							    <input name="end-dtm" class="eventend_time" type="text" placeholder="End Time (YYYY-MM-DD HH:MM)"/>
						    	</br>
				...
				<div class="add_daily">
					<div class="grid_2">
						<div class="dailyview_calendar">
                    		<a href="#" onclick="return false;"><image onclick="viewChange('agendaDay')" src="img/daily button.jpg" id="dayPic"/></a>
						</div>
					</div>
				</div>
				<!--End Daily View Button-->


				<!--Weekly View Button-->
				<div class="grid_2 weeklyview_calendar">
                        <a href="#" onclick="return false;"><image id="weekPic" onclick="viewChange('agendaWeek')" src="img/weekly button.jpg" /></a>
				</div>
				<!--End Weekly View Button-->

				<!--Monthly View Button-->
				<div class="grid_2"> 
					<div class="monthlyview_calendar active">
                        <a href="#" onclick="return false;"><image id="monthPic" onclick="viewChange('month')" src="img/monthly button.jpg"></a>
					</div>
				</div>
				<!--End Monthly View Button-->
